...
syn region txtNote start="\/\#" end="\#\/" contains=@txtAlwaysContains
...
syn keyword txtTodo _todo fixme xxx _note

syn keyword txtError _error _bug

syn keyword txtDebug _debug
